...
public class Commit implements Serializable {
    ...
    public Commit(String message, List<Commit> parents, stage stages) {
        ...
        for (Map.Entry<String, String> item : stages.getAdded().entrySet()) {
            String filename = item.getKey();
            String blobId = item.getValue();
            blobs.put(filename, blobId);
        }
        for (String filename : stages.getRemoved()) {
